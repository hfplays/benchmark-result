...
// ============================================================================
// BENCHMARK DATASET - 2024
// ============================================================================

// Grand Theft Auto V | Celeron N4000
setGameName('celeron-n4000', 'gta-v-2024', 'Grand Theft Auto V');
setGameStatus('celeron-n4000', 'gta-v-2024', false);
setGameUpdate('celeron-n4000', 'gta-v-2024', '2024-01-15');
setGameVideo('celeron-n4000', 'gta-v-2024', 'Qo9bZXsoUYw');
setBenchData('celeron-n4000', 'gta-v-2024', '800x600 | Normal', 14, 1, 83, 81);
setGameNote('celeron-n4000', 'gta-v-2024', 'Completely unplayable. Heavy stuttering with 1% Low dropping to 1 FPS, severe input delay, and high CPU thermals peaking at 83°C.');